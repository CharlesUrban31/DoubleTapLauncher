using DoubleTapMobile.Models.About;
...
namespace DoubleTapMobile.ViewModels.About
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:DoubleTapMobile.ViewModels.About.AboutUsViewModel"/> class.
        /// </summary>
        ...
        {
            var file = "DoubleTapMobile.Data." + fileName;
